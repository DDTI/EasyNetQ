...
namespace EasyNetQ.Tests.Integration
{
    ...
    public class PersistentChannelTests
    {
        ...
        {
            persistentChannel.InvokeChannelAction(x => x.ExchangeDeclare("myExchange", "direct"),DateTime.Now);
        }
        ...
        public void Should_allow_non_disconnect_Amqp_exception_to_bubble_up()
        {
            ...
            persistentChannel.InvokeChannelAction(x => x.ExchangeDeclare("myExchange", "topic"),DateTime.Now);
        }
