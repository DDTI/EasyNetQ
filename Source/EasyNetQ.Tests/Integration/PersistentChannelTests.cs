...
namespace EasyNetQ.Tests.Integration
{
    ...
    public class PersistentChannelTests : IDisposable
    {
        ...
        {
            persistentChannel.InvokeChannelAction(x => x.ExchangeDeclare("myExchange", "direct", true, false, new Dictionary<string, object>()),DateTime.Now);
        }
        ...
        public void Should_allow_non_disconnect_Amqp_exception_to_bubble_up()
        {
            ...
            persistentChannel.InvokeChannelAction(x => x.ExchangeDeclare("myExchange", "topic", true, false, new Dictionary<string, object>()),DateTime.Now);
        }
